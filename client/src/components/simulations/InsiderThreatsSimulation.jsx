...
function InsiderThreatsSimulation({ simulation, onComplete }) {
  ...
  const handleStageComplete = (stage, result) => {
    ...
    const stages = ['monitor', 'investigation', 'response'];
          ...
          >
            ...
            <div className="space-y-2 text-sm text-gray-300">
              <div className="flex justify-between">
                ...
                <span>{stageScores.monitor.score}/{stageScores.monitor.max}</span>
              </div>
              <div className="flex justify-between">
                <span>Расследование</span>
                <span>{stageScores.investigation.score}/{stageScores.investigation.max}</span>
              </div>
              <div className="flex justify-between">
    ...
    <div className="relative w-full h-full overflow-hidden bg-gray-900">
      <AnimatePresence mode="wait">
        {currentStage === 'monitor' && (
          ...
          >
            <ActivityMonitor
              onComplete={(result) => handleStageComplete('monitor', result)}
            />
          </motion.div>
        )}
        ...
        {currentStage === 'investigation' && (
          ...
          >
            <ThreatInvestigation
              onComplete={(result) => handleStageComplete('investigation', result)}
            />
          </motion.div>
        )}
...
export default InsiderThreatsSimulation;
